...
const getRiskBadgeClass = (level: string) => {
    switch (level.toLowerCase()) {
        ...
        case "ekstrim":
        case "extreme":
            return "border border-red-300 bg-red-100 text-red-900 hover:bg-red-100"
        default:
...
function createRiskLevelIcon(riskLevel: string, selected: boolean) {
    ...
    const tone = normalizedRiskLevel === "ekstrem" || normalizedRiskLevel === "ekstrim" || normalizedRiskLevel === "extreme" ? "dark-red" : riskLevel === "Tinggi" ? "red" : riskLevel === "Sedang" ? "yellow" : "green"
